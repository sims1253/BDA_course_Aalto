...
analysis according to all the parts of the Bayesian workflow studied along
...
- Start working on the project midway through the course.
...
business), whether you prefer R or Python, and whether you already have a more concrete idea for the topic.
...
The report should include
  ...
  1. Description of the data and the analysis problem. Provide information on where the data was obtained, and if it has been previously used in some online case study and how your analysis differs from the existing analyses.
  ...
  1. How the inference for models was run, that is, what options were used. This is also more clear as a combination of textual explanation and the actual code line.
  ...
  1. Conclusion of what was learned from the data analysis.
  1. Self-reflection of what you/the group learned while making the project.
...
## Model requirements
  ...
  - A hierarchical model is a model where the prior of certain parameters contains other parameters that are also estimated in the model. For instance,
...
The following case study examples demonstrate how text, equations, figures, and code, and inference results can be included in one report. These examples don't necessarily have all the workflow steps required in your report, but different steps are illustrated in different case studies and you can get good ideas for your report just by browsing through them.
  ...
  - [BDA R and Python demos](demos.html) are quite minimal in the description of the data and discussion of the results but show many diagnostics and basic plots.
